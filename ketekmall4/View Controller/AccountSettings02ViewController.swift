...
//    @IBOutlet weak var btnUploadServer: UIButton!
    ...
    override func viewDidLoad() {
        ...
        PhoneNo.isUserInteractionEnabled = false
        Address01.isUserInteractionEnabled = false
        Address02.isUserInteractionEnabled = false
        City.isUserInteractionEnabled = false
        PostCode.isUserInteractionEnabled = false
        Birthday.isUserInteractionEnabled = false
        BankName.isUserInteractionEnabled = false
        BankAcc.isUserInteractionEnabled = false
...
//        btnUploadServer.setTitle("Upload to Server".localized(lang: str), for: .normal)
    ...
    @IBAction func EditProfile(_ sender: Any) {
        ...
        PhoneNo.isUserInteractionEnabled = true
        Address01.isUserInteractionEnabled = true
        Address02.isUserInteractionEnabled = true
        City.isUserInteractionEnabled = true
        PostCode.isUserInteractionEnabled = true
        Birthday.isUserInteractionEnabled = true
        BankName.isUserInteractionEnabled = true
        BankAcc.isUserInteractionEnabled = true
    }
